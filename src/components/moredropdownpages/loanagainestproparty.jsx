...
property
          ...
          <div className="mt-8 pl-20 md:mt-0">
            <img
              src="https://dugtmg0pklp2w.cloudfront.net/cross-sell/ic-lap-login-desktop-v2.png"
              alt="Person pointing"
